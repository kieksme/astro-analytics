...
<body>
  ...
  <div class="meta">
    <span><strong>Property ID</strong> <span id="propertyId"><%= it.propertyId %></span></span>
    <span><strong>Pages in cache</strong> <span id="cacheSize"><%= it.cacheSize %></span></span>
  </div>
  <div class="toolbar-row">
    <button type="button" class="btn-refresh" id="refreshBtn"><%- it.refreshSvg %> Refresh data</button>
  ...
  <div id="tableWrap">
    <table>
      <thead><tr>
        <th data-sort="pagePath">Page <span class="sort-icon"><%- it.sortSvg %></span></th>
        <th data-sort="bounceRate">Bounce <span class="sort-icon"><%- it.sortSvg %></span></th>
      </tr></thead>
  ...
  <script type="application/json" id="dataPayload"><%- it.dataPayload %></script>
